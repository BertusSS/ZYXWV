...
mount_vfs_texture_path  (current_mod_path.."/Models/Textures/Impala-Mk1_Textures.zip");
mount_vfs_texture_path  (current_mod_path.."/Models/Textures/SU-27S-CPT-TEXTURES");
...
Impala_MkI_Su27Cpt = {
	...
	Name 				=   'Impala-Mk1',
	DisplayName			= _('Impala-Mk1'),
	
	-- HumanCockpit 		= true,
	-- HumanCockpitPath    = current_mod_path..'/Cockpit/',

	Picture 			= "Impala-Mk1.png",
...
--zero fuel weight 2735 kg (6030 lb) + crew weight: 163 kg (360 lb) + fuel weight: 1083 kg (2388 lb) = 3981 kg (8777 lb) + external stores 1235 kg (2722 lb) = 5216 kg (11500 lb)
	M_empty	=	2735,-- should be zero fuel weight 2735 kg (6030 lb)
	M_nominal	=	2898,-- 2735 kg (6030 lb) + crew weight: 163 kg (360 lb) --(zero fuel)
	M_max	=	5216,-- 5216 kg (11500 lb) max take-off weapon training full fuel
	M_fuel_max	=	1083,-- 1083 kg (2388 lb)
	H_max	=	12000,-- m
	...
	-- nose_gear_pos 				= {3.2549474239, -1.1137815714,0.0},  
	-- main_gear_pos 				= { -1.1374191046, -1.1937814951, 1.157381773},
	...
	wing_area	=	19.0,
	wing_span	=	10.56,
	thrust_sum_max	=	1224,--2,700 lb (12 kN)
	thrust_sum_ab	=	1224,
	Vy_max	=	30,
	length	=	10.65,
	height	=	3.72,
...
----------------- SUSPENSION CODE
	...
	crew_members = 
	{
		[1] = 
		{
			...
			drop_canopy_name   = "Impala-Mk1_canopy",
	...
	Guns = {gun_mount("ADEN", {
			...
			muzzle_pos_connector = "GUN_POINT_PORT",
			muzzle_pos 		  = {1, -0.5, -1},
...
add_aircraft(Impala_MkI_Su27Cpt)
