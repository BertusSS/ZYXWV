ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		CockpitLocalPoint      = {2.2279531956, 0.76, 0.0},--Cockpit nach = vorne,hoch
		...
		limits_6DOF            = {x = {-0.05,0.45},y ={-0.3,0.1},z = {-0.22,0.22},roll = 90},--Bewegen = hinten vorne,oben unten,links rechts
